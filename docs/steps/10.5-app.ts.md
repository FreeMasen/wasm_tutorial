...
<p>The rest of this file is dedicated to our <code>App</code> class. This will act as an interface between the user and our data. Eventually we are going to insert our <code>bincode_parser</code> logic into this but right now we just need to make sure everything works.</p>
</div>
